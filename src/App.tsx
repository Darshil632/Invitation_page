      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl">
          ...
          >
            ...
            >
              <img src={ganeshIcon} alt="Lord Ganesha" className="h-12 w-auto object-contain opacity-90 drop-shadow-sm" />
            </motion.div>
            <motion.div
            ...
            <h1 className="text-6xl md:text-8xl mb-6 text-amber-900 font-serif">
              Yogesh & Veera
            </h1>
